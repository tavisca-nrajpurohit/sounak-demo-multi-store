...
function ACTION_CART_ADD_TO_LIST_REQUEST(data, formType) {
    return {
...
const dynamic_redux_1 = __webpack_require__(8);
...
class MyCart extends lit_element_1.LitElement {
    ...
    firstUpdated() {
        ...
        //////////////////////___________EXTRA CODE____________//////////////////////////////////////
        window.addEventListener('CART_ADD_TO_CART', e => this.store.dispatch(actions_1.ACTION_CART_ADD_TO_LIST_REQUEST(e["detail"].payload, e["detail"].formType)));
        window.addEventListener('INFO_TO_CART_ADD_TO_CART', e => this.store.dispatch(actions_1.ACTION_CART_ADD_TO_LIST_REQUEST(e["detail"].payload, e["detail"].formType)));
        //////////////////////___________EXTRA CODE____________/////////////////////////////////////////
    }
    render() {
